    ...
    <div class="wrapper">
      <div class="header">
        <div class="action">
          ...
          <!-- <round-button :icon="'mdi-check'" :primary="true" /> -->
        </div>
        <div class="main-information">
          <div v-if="errorMessage" class="error-message">
            {{ errorMessage }}
          </div>
          <div class="page-title">Tambah Material</div>
        </div>
      </div>
  ...
  data() {
    return {
      ...
      nameInput: {
        label: "Material",
        type: "text",
        model: this.data ? this.data.name : "",
        placeholder: "...",
        rules: [this.notEmpty],
      },
    };
  ...
  methods: {
    ...
    async submit() {
      try {
        ...
        const { data } = await $axios.post(`${$config.apiURL}/materials`, {
          name,
        });
        ...
        switch (e.message) {
          case "INVALID_REQUEST":
            ...
            break;
          case "MATERIAL_ALREADY_EXIST":
            this.errorMessage = "Material tersebut telah dipakai";
            break;
          default:
