    ...
    <div class="wrapper">
      <div class="header">
        ...
        <div class="main-information">
          ...
          <div class="page-title">Atur Material</div>
        </div>
      </div>
      <div class="body">
        <div class="tab">
          <div
            ...
            class="materialData"
          >
            <div class="details" @click="edit(material)">
              <div class="material">
                {{ material.name }}
              </div>
            </div>
  ...
  methods: {
    ...
    edit(user) {
      if (
        ...
        this.$root.$emit("material-edit", user);
    },
    async panggil() {
      const { data } = await this.$axios.get(
        `${this.$config.apiURL}/materials`
      );
      if (data.message !== "SUCCESS") console.log(data.message);
      this.materialList = data.materials;
    },
    async deleteMaterial(user) {
      try {
        const { $axios, $config } = this;
        const { data } = await $axios.delete(
          `${$config.apiURL}/materials/${user}`
        );
